...
class DenonAVRTelnet extends AVRModule
{
	...
	public function MainzoneAutoStandbySetting(int $Value)
	...
	//Mainzone Standby Setting
	public function MainzoneEcoModeSetting(string $Value)
	{ // On / Auto / Off
	...
	//Master Volume
	public function MasterVolume(string $command)
	{ // "UP" or "DOWN"
	...
	public function MasterVolumeFix(float $Value)
	...
	//Dynamic Volume
	public function DynamicVolume(string $Value)
	...
	//Dolby Volume
	public function DolbyVolume(bool $Value)
	...
	public function DolbyVolumeModeler(string $Value)
	...
	public function DolbyVolumeLeveler(string $Value)
	...
	//Dynamic Compressor
	public function DynamicCompressor(string $Value)
	...
	public function DynamicRangeCompression(string $Value)
	...
	//Audyssey DSX
	public function AudysseyDSX(string $Value)
	...
	//CinemaEQ
	public function CinemaEQ(bool $Value)
	...
	//Panorama
	public function Panorama(bool $Value)
	...
	//Dynamic EQ
	public function DynamicEQ(bool $Value)
	...
	//Channel Volume
	public function ChannelVolumeFL(float $Value)
	...
	public function ChannelVolumeFR(float $Value)
	{ // Range -12 to 12, Step 0.5
		$SubCommand = (new DENONIPSProfiles())->GetSubCommandOfValue(DENON_API_Commands::CVFL, $Value);
		$this->SendCommand(DENON_API_Commands::CVFR . $SubCommand);
	}

	public function ChannelVolumeC(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSW(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSW2(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSL(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSR(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSBL(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSBR(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSB(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeFHL(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeFHR(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeFWL(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeFWR(float $Value)
	{ // Range -12 to 12, Step 0.5
	...
	public function ChannelVolumeSHL(float $Value)
	...
	public function ChannelVolumeSHR(float $Value)
	...
	public function ChannelVolumeTS(float $Value)
	...
	public function ChannelVolumeTFL(float $Value)
	...
	public function ChannelVolumeTFR(float $Value)
	...
	public function ChannelVolumeTML(float $Value)
	...
	public function ChannelVolumeTMR(float $Value)
	...
	public function ChannelVolumeTRL(float $Value)
	...
	public function ChannelVolumeTRR(float $Value)
	...
	public function ChannelVolumeRHL(float $Value)
	...
	public function ChannelVolumeRHR(float $Value)
	...
	public function ChannelVolumeFDL(float $Value)
	...
	public function ChannelVolumeSDR(float $Value)
	...
	public function ChannelVolumeBDL(float $Value)
	...
	public function ChannelVolumeBDR(float $Value)
	...
	//RecSelect
	public function RecSelect(string $command)
	...
	//Subwoofer
	public function Subwoofer(bool $Value)
	...
	//Subwoofer ATT
	public function SubwooferATT(bool $Value)
	...
	//Tone CTRL
	public function ToneCTRL(bool $Value)
	...
	//Audio Delay
	public function AudioDelay(int $Value)
	...
	public function SpeakerOutputFront(string $Value)
	...
	public function AutoFlagDetectMode(bool $Value)
	...
	//ASP
	public function ASP(string $Value)
	{ // ASP Normal / Full
	...
	//Audio Restorer
	public function AudioRestorer(string $Value)
	...
	//Center Image
	public function CenterImage(float $Value)
	...
	//Center Width
	public function CenterWidth(float $Value)
	...
	//Input Mode
	public function SelectDecodeMode(string $Value)
	...
	//Digital Input Mode
	public function DigitalInputMode(string $Value)
	...
	//Dimension
	public function Dimension(int $Value)
	...
	//Effect Level
	public function EffectLevel(float $Value)
	...
	//HDMI Audio Output
	public function HDMIAudioOutput(string $Value)
	...
	//Multi EQ Mode
	public function MultiEQMode(string $Value)
	...
	//PLIIZHeightGain
	public function PLIIZHeightGain(string $Value)
	...
	//Reference Level
	public function ReferenceLevel(int $Value)
	...
	//Room Size
	public function RoomSize(string $Value)
	...
	//Stage Width
	public function StageWidth(float $Value)
	...
	//Stage Height
	public function StageHeight(float $Value)
	{ //Stage Width can be operated from -10 to +10 Step 0.5
	...
	//Surround Back Mode
	public function SurroundBackMode(string $Value)
	...
	//Surround Play Mode
	public function SurroundPlayMode(string $Value)
	...
	//Vertical Stretch
	public function VerticalStretch(bool $Value)
	...
	//Contrast
	public function Contrast(float $Value)
	...
	//Brightness
	public function Brightness(float $Value)
	...
	//Chroma Level
	public function ChromaLevel(float $Value)
	...
	public function DigitalNoiseReduction(string $Value)
	...
	//Enhancer
	public function Enhancer(float $Value)
	 ...
	 */
	public function HDMIMonitor(string $Value)
	{ // HDMI Monitor AUTO / Monitor 1 / Monitor 2
		...
		$result = $this->SendCommand(DENON_API_Commands::VSMONI . $SubCommand);
		return $result;
	}

	//Hue
	public function Hue(float $Value)
	...
	//Resolution
	public function Resolution(string $Value)
	...
	//Resolution HDMI
	public function ResolutionHDMI(string $Value)
	...
	public function VideoProcessingMode(string $Value)
	...
	public function GUISourceSelectMenu(bool $Value)
	...
	//PS
	public function ParameterSettings(string $subcommand)
	{ // PS
	...
	//Bass Level
	public function BassLevel(float $Value)
	...
	//Treble Level
	public function TrebleLevel(float $Value)
	{ // can be operated from -6 to +6, Step 0.5
	...
	//LFE Level
	public function LFELevel(float $Value)
	...
	//Sleep
	public function SLEEP(int $Value)
	...
	public function Z2_Volume(string $command)
	{ // "UP" or "DOWN"
		$this->SendCommand(DENON_API_Commands::Z2 . $command);
	}

	public function Zone2VolumeFix(float $Value)
	...
	public function Zone2InputSource(string $subcommand)
	{ // PHONO ; DVD ; HDP ; "TV/CBL" ; SAT ; "NET/USB" ; DVR ; TUNER
		$this->SendCommand(DENON_API_Commands::Z2 . $subcommand);
	}

	//Channel Volume Front Left
	public function Zone2ChannelVolumeFL(float $Value)
	{ // -12 to 12, Step 0.5
	...
	public function Zone2ChannelVolumeFR(float $Value)
	{ // -12 to 12, Step 0.5
	...
	public function Zone2ChannelSetting(string $Value)
	...
	public function Zone2QuickSelect(string $command)
	...
	public function Z3_Volume(string $command)
	{ // "UP" or "DOWN"
		$this->SendCommand(DENON_API_Commands::Z3 . $command);
	}

	public function Zone3VolumeFix(float $Value)
	{ // 18(db) bis -80(db), Step 0.5
	...
	public function Zone3InputSource(string $subcommand)
	{ // PHONO ; DVD ; HDP ; "TV/CBL" ; SAT ; "NET/USB" ; DVR ; TUNER
		$this->SendCommand(DENON_API_Commands::Z3 . $subcommand);
	}

	//Channel Volume Front Left
	public function Zone3ChannelVolumeFL(float $Value)
	{ // -12 to 12, Step 0.5
	...
	//Channel Volume Front Right
	public function Zone3ChannelVolumeFR(float $Value)
	{ // -12 to 12, Step 0.5
	...
	public function Zone3ChannelSetting(string $Value)
	...
	public function Zone3QuickSelect(string $command)
	...
	private function FormMainzone($Zone, $AVRType)
	{
		$AVRCaps = AVRs::getCapabilities($AVRType);
		if ($this->debug) {
